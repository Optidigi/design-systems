...
const DEFAULT_FALLBACK = {
  light: { accent: "#18181b", bg: "#ffffff" } as Palette,
  dark: { accent: "#fafafa", bg: "#09090b" } as Palette,
}
...
const COLOR_INPUT_FALLBACK_HEX = "#888888"
        ...
        <div className="flex flex-wrap items-center gap-2">
          {rows.map((row) => (
            ...
            >
              <span
                aria-hidden
                style={{ background: swatchFor(row.palette) }}
                className={cn(
                  swatchClass,
                  row.isActive
