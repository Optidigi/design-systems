...
import { ThemedNodeDialog } from "@/components/ui/themed-node-dialog"
...
export const ThemedPill: React.FC<ThemedPillProps> = ({ id, props, nodeKey }) => {
  ...
  const themedTextClass: Record<string, string> = {
    eyebrow: "inline-block -rotate-2 text-[20px] text-accent",
  }
  const themedTextStyle: Record<string, React.CSSProperties> = {
    eyebrow: { fontFamily: "var(--font-script, ui-serif, Georgia, serif)" },
  }
